 ...
 * Las clases propias empiezan por `fe-` y nunca encajan. Es la misma
 * comprobación que la de innoboxrr-form-elements.
 */
...
/** Los valores de class, className y custom-class del archivo. */
...
describe('clases de los componentes', () => {
     ...
     * de Tailwind que el paquete no declara: en una aplicación sin Tailwind
     * salían sin estilo. El aspecto sale del tema de innoboxrr-form-core.
     */
    ...
    it('la comprobacion reconoce una utilidad y respeta las clases propias', () => {
        const tokens = classTokens('<label className="ml-2 text-sm dark:text-white fe-label"></label>')
